    ...
    <div class="page-content">
        <div class="center-page-content">
            <div class="panel panel-default">
                <div class="panel-heading center-align"><strong>Add Site Info</strong></div>
                <div class="panel-body">
                    <span id="itemRow">
                        <?php echo validation_errors(); ?>
                    </span>
                    <form name="sites_frm" id="site_frm" method="POST" action="<?php echo base_url() . 'admin/site/save_site' ?>" enctype="multipart/form-data" >
                        <table width="100%" border="0" id="table_Row">
                                ...
                                <td>
                                    <span id="itemRow">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" type="text" id="name" name="name" value="<?php echo set_value('name'); ?>" placeholder="Site Name">
                                        </div>
                                    </span>
                                    <br/>   
                                </td>
                                ...
                                <td>
                                    <span id="itemRow">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" type="text" id="url" name="url" value="<?php echo set_value('url'); ?>" placeholder="Site URL">
                                        </div>
                                    </span>
                                    <br/>
                                ...
                                <td>
                                    <span id="itemRow">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" type="text" id="desc" name="desc" value="<?php echo set_value('desc'); ?>" placeholder="Site Descrtion">
                                        </div>
                                    </span>
                                    <br/>
                            ...
                            <tr id="row_5">
                                <td>
                                    <span id="itemRow">
                                        <div class="input-group">
                                            <span class="input-group-addon" >
                                                <input type="checkbox" onclick="check_uncheck();" value="1" <?php echo set_checkbox('is_paginate', '1',False); ?> id="is_paginate" name="is_paginate"> Pagination
                            ...
                            <tr id="row_6" style="display: none;">
                                <td>
                                    <span id="itemRow">
                                        <div class="input-group">
                                            <span class="input-group-addon" > <input style="float: left;" class="input-sm" type="text" id="total_products" name="total_products" placeholder="Total Products"></span>
                                            <span class="input-group-addon" style="width: 100px;"> <input class="form-control" type="text" id="link_pattern" name="link_pattern" placeholder="Link Pattern"></span>
                                        </div>
                                        <br />
                                    </span>
                                    <br/>
