...
<div class="container top">
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">
            <?php echo ucfirst("Add Pattern"); ?>
        </li>
    </ul>

    <div class="page-header users-header">
        <h2>
            <?php echo ucfirst("Add Site Pattern"); ?>
        </h2>
    </div>
    <div class="page-content">
        <div class="center-page-content">
            <div class="panel panel-default">
                <div class="panel-heading center-align"><strong>Add Site Pattern </strong></div>
                <div class="panel-body">
                    <span id="itemRow">
                        <?php echo validation_errors(); ?>
                    </span>
                    <form name="sites_frm" id="site_frm" method="POST" action="<?php echo base_url() . 'admin/site/save_pattern' ?>" enctype="multipart/form-data" >
                                ...
                                <td>
                                    <span id="itemRow">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" type="text" id="name" name="name" value="<?php echo set_value('name'); ?>" placeholder="Pattern Name">
                                        </div>
                                    </span>
                                    <br/>   
                                </td>
                                ...
                                <td>
                                    <span id="itemRow">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" type="text" id="url" name="url" value="<?php echo set_value('url'); ?>" placeholder="Pattern List">
                                        </div>
                                    </span>
                                    <br/>
                                    ...
                                    <span id="itemRow">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                                ...
                                                <input type="checkbox" value="1" <?php echo set_checkbox('is_table', '1'); ?> name="is_table" id="is_table"> Is Table  
                                            </span>
                                        ...
                                        <div id="is_table_tr" class="input-group-addon" style="display: none;">
                                                <span id="itemRow">
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" type="text" id="total_colums" name="total_colums" value="<?php echo set_value('total_colums'); ?>" placeholder="Total Colums in Row">
                                                    </div>
                                                </span>
                                                <br/>
                                                <span id="itemRow">
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" type="text" id="req_colum" name="req_colum" value="<?php echo set_value('req_colum'); ?>" placeholder="Required Colum Number">
                                                    </div>
                                                </span>
                                                <br/>
                                            </div>
