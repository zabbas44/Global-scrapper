...
<div class="container top">
  ...
  <!--          <span class="divider">/</span>-->
        ...
        <li class="active">
            <?php echo ucfirst("Edit Question"); ?>
        </li>
    </ul>
        ...
        <div class="center-page-content">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form name="sites_frm" id="site_frm" method="POST" action="<?php echo base_url() . 'question/update_save_question' ?>" enctype="multipart/form-data" >
                        <input type="hidden" name="q_id" id="q_id" value="<?php echo $site['q_id'];?>" />
                        ...
                        <table width="100%" border="0" id="table_Row">
                                ...
                                <td>
                                    <span id="itemRow">
                                        <div class="input-group">
                                            <span class="input-group-addon"><b>Product Title</b></span>
                                            <input class="form-control" type="text" id="pro_name" name="pro_name" value="<?php echo $site['q_product_title'];?>" placeholder="Product Name">
                                        </div>
                                    </span>
                                    <br/>   
                                </td>
                            ...
                            <tr id="row_2">
                                <td>
                                    <span id="itemRow">
                                        <div class="input-group">
                                            <span class="input-group-addon"><b>Product ID</b></span>
                                            <input class="form-control" type="text" id="pro_id" name="pro_id" value="<?php echo $site['q_product_id'];?>" placeholder="Product ID">
                                        </div>
                                    </span>
                                    <br/>   
                                </td>
                            ...
                            <tr id="row_3">
                                <td>
                                    <span id="itemRow">
                                        <div class="input-group">
                                            <span class="input-group-addon"><b>Product Link</b></span>
                                            <input class="form-control" type="text" id="pro_link" name="pro_link" value="<?php echo $site['q_product_url'];?>" placeholder="Product Link">
                                        </div>
                                    </span>
                                    <br/>   
                                </td>
                            ...
                            <tr id="row_4">
                                <td>
                                    <span id="itemRow">
                                        <div class="input-group">
                                            <span class="input-group-addon"><b>Question</b></span>
                                            <input class="form-control" type="text" id="question" name="question" value="<?php echo $site['q_text'];?>" placeholder="Enter Question">
                                        </div>
                                    </span>
                                    <br/>
                                    ...
                                    <span id="itemRow">
                                        <div class="input-group">
                                            <span class="input-group-addon" >
                                                <input type="radio" value="1"  <?php echo ($site['q_status']==1)?'checked=""':'';?>  name="is_active"> Active
                                               <input type="radio" value="2" <?php echo ($site['q_status']==2)?'checked=""':'';?>  name="is_active"> InActive 
                                            </span>
                                        </div>
